			...
			<Card className="mt-10 w-[400px]">
				...
				<CardBody>
					<div className="pb-4 pt-6">
						...
						<p className="max-w-[90%] text-small text-default-400">@weijunext</p>
						...
						<p className="py-2 text-small text-foreground">Next.js开源手艺人｜掘金签约作者｜出海鼓励师</p>
						<div className="w-full text-center mt-4 flex justify-evenly">
							<FollowButton name="Twitter/X" href="https://twitter.com/weijunext/"></FollowButton>
							<FollowButton name="Github" href="https://github.com/weijunext/"></FollowButton>
							<FollowButton name="掘金" href="https://juejin.cn/user/26044008768029"></FollowButton>
						</div>
					</div>
				</CardBody>
			</Card>
